...
class FabricRandomUser(loader.Module):
    """Choose random user in chat."""

    emoji_list = list(grapheme.graphemes("🤩🥳🤪😜😝😋😘🤯🤠😈🎃😺👀🙊🙈🙉🐵🐸🐣🌝🌚🌜🌛🌙✨⚡️🌟⭐️💫💥☄️❄️☀️🌪🔥☃️☁️💨💧💦🌊🍓🍉🍋🍊🍐🍎🍌🍇🫐🍈🍒🍑🥭🍍🥝"))

    strings = {
        "name": "F5 RandomUser",
        "fabric-modules-btn": "🧶 Fabric Modules 🧶",
    ...
    strings_ru = {
        "_cls_doc": "Выбрать рандом юзер в чате.",
    ...
    async def rand_user_inline(self, call: InlineCall):
        ...
        await call.edit(
            ...
            reply_markup=[
                ...
                [
                    {
                        "text": self.strings("fabric-modules-btn"),
                        "url": "https://t.me/fabricml"
                    }
                ]
            ]
        )
